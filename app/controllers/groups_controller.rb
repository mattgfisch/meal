class GroupsController < ApplicationController
  ...
  def show
    ...
    render json: {hangoutAdmin: hangout_admin, activeMembers: active_members, groupTitle: group.name, groupMembers: group_members, groupAdminId: group.admin_id, hangoutId: hangout_id, inHangout: in_hangout, centerPoint: center_point }
  end
